...
const AccDetail = (props) => {
    ...
    const data = props.dataAcc.filter(product => product.idCategory === 'acc01').slice(0, 5)
...
const mapStateToProps = state => {
    return {
        dataAcc: state.DataReducer.rootData
    }
}

export default connect(mapStateToProps, null)(AccDetail)
